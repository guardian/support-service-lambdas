...
- [handlers/imovo-rewards/jest.config.js](handlers/imovo-rewards/jest.config.js)
- [handlers/imovo-rewards/package.json](handlers/imovo-rewards/package.json)
- [handlers/imovo-rewards/riff-raff.yaml](handlers/imovo-rewards/riff-raff.yaml)
- [handlers/imovo-rewards/tsconfig.json](handlers/imovo-rewards/tsconfig.json)
- [handlers/imovo-rewards/BUILDCHECK.md](handlers/imovo-rewards/BUILDCHECK.md)
