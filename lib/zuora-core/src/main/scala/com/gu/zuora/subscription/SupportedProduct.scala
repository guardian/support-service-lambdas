  ...
  lazy val supportedProducts = List(
    ...
    SupportedProduct(
      ...
      ratePlans = List(
        ...
        SupportedRatePlan("Guardian Weekly 6 Issues", List(SupportedRatePlanCharge("Zone A 6 Issues", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly 6 Months", List(SupportedRatePlanCharge("Zone A 6 Months", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly 6 Months Only", List(SupportedRatePlanCharge("Zone A 6 Months", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly Annual", List(SupportedRatePlanCharge("Zone A Annual", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly Quarterly", List(SupportedRatePlanCharge("Zone A Quarterly", DayOfWeek.FRIDAY)))
      )
    ),
    SupportedProduct(
      ...
      ratePlans = List(
        ...
        SupportedRatePlan("Guardian Weekly 6 Issues", List(SupportedRatePlanCharge("Zone B 6 Issues", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly 6 Months", List(SupportedRatePlanCharge("Zone B 6 Months", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly 6 Months Only", List(SupportedRatePlanCharge("Zone B 6 Months", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly Annual", List(SupportedRatePlanCharge("Zone B Annual", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly Quarterly", List(SupportedRatePlanCharge("Zone B Quarterly", DayOfWeek.FRIDAY)))
      )
    ),
    SupportedProduct(
      ...
      ratePlans = List(
        ...
        SupportedRatePlan("Guardian Weekly 6 Months", List(SupportedRatePlanCharge("Zone C 6 Months", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly 6 Months Only", List(SupportedRatePlanCharge("Zone C 6 Months", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly Annual", List(SupportedRatePlanCharge("Zone C Annual", DayOfWeek.FRIDAY))),
        SupportedRatePlan("Guardian Weekly Quarterly", List(SupportedRatePlanCharge("Zone C Quarterly", DayOfWeek.FRIDAY)))
      )
    ),
    SupportedProduct(
