...
class BillingScheduleSpec extends FlatSpec with Matchers with EitherValues with TypeCheckedTripleEquals {
  ...
  it should "calculate monthly billing periods" in {
    testFixedBillingSchedule(
      ...
      BillingPeriod(LocalDate.of(2019, 10, 1), LocalDate.of(2019, 11, 1)),
      BillingPeriod(LocalDate.of(2019, 11, 1), LocalDate.of(2019, 12, 1))
    )
  }
  it should "calculate annual billing periods" in {
    testFixedBillingSchedule(
      ...
      None,
      LocalDate.of(2019, 10, 1),
      BillingPeriod(LocalDate.of(2019, 10, 1), LocalDate.of(2020, 10, 1)),
      BillingPeriod(LocalDate.of(2020, 10, 1), LocalDate.of(2021, 10, 1))
    )
  }
  it should "calculate Semi_Annual billing periods" in {
    testFixedBillingSchedule(
      ...
      None,
      LocalDate.of(2019, 10, 1),
      BillingPeriod(LocalDate.of(2019, 10, 1), LocalDate.of(2020, 4, 1)),
      BillingPeriod(LocalDate.of(2020, 4, 1), LocalDate.of(2020, 10, 1))
    )
  }
  it should "calculate Quarter billing periods" in {
    testFixedBillingSchedule(
      ...
      None,
      LocalDate.of(2019, 10, 1),
      BillingPeriod(LocalDate.of(2019, 10, 1), LocalDate.of(2020, 1, 1)),
      BillingPeriod(LocalDate.of(2020, 1, 1), LocalDate.of(2020, 4, 1))
    )
  }
  it should "calculate specific weeks billing periods" in {
    testFixedBillingSchedule(
      ...
      Some(3),
      LocalDate.of(2019, 10, 1),
      BillingPeriod(LocalDate.of(2019, 10, 1), LocalDate.of(2019, 10, 22)),
      BillingPeriod(LocalDate.of(2019, 10, 22), LocalDate.of(2019, 11, 12))
    )
  }
  ...
  private def testFixedBillingPeriod(zuoraBillingPeriodId: String, optionalSpecificBillingPeriod: Option[Int], billingPeriodsRatePlanIsValidFor: Int, effectiveStartDate: LocalDate, expectedEndDate: LocalDate) = {
    inside(
      ...
      case Right(billingSchedule) =>
        ...
        billingSchedule.isDateCoveredBySchedule(expectedEndDate.plusDays(1)) should equal(false)
    }
  }
