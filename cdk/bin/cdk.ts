...
import { APP_NAME as SINGLE_CONTRIBUTIONS_PROCESSOR_APP_NAME, SingleContributionsProcessorStack } from '../lib/single-contributions-processor';
...
new SingleContributionsProcessorStack(app, `${SINGLE_CONTRIBUTIONS_PROCESSOR_APP_NAME} -CODE`, {stack: "membership", stage: "CODE"});
new SingleContributionsProcessorStack(app, `${SINGLE_CONTRIBUTIONS_PROCESSOR_APP_NAME} -PROD`, {stack: "membership", stage: "PROD"});
