...
import {
	APP_NAME as SINGLE_CONTRIBUTIONS_PROCESSOR_APP_NAME,
	SingleContributionsProcessorStack,
} from '../lib/single-contributions-processor';
...
new FailedNationalDeliveriesProcessor(
	app,
	'failed-national-deliveries-processor-CODE',
