...
const tomTestLambda: HandlerDefinition = {
	name: 'tom-test-lambda',
	dependencies: {
		...dep.zod,
	},
	devDependencies: {
	...
	extraScripts: {
		...openApiScripts,
		package: `pnpm type-check && pnpm lint && pnpm openapi:lint && pnpm check-formatting && pnpm test && pnpm build && cd target && zip -qr tom-test-lambda.zip ./*.js.map ./*.js`,
	},
};
