...
const grahamTestLambda: HandlerDefinition = {
	name: 'graham-test-lambda',
	dependencies: {
		...dep.zod,
	},
	devDependencies: {
	...
	extraScripts: {
		...openApiScripts,
		package: `pnpm type-check && pnpm lint && pnpm openapi:lint && pnpm check-formatting && pnpm test && pnpm build && cd target && zip -qr graham-test-lambda.zip ./*.js.map ./*.js`,
	},
};
