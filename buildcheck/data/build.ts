...
const paulTestLambda: HandlerDefinition = {
	name: 'paul-test-lambda',
	dependencies: {
		...dep.zod,
	},
	devDependencies: {
	...
	extraScripts: {
		...openApiScripts,
		package: `pnpm type-check && pnpm lint && pnpm openapi:lint && pnpm check-formatting && pnpm test && pnpm build && cd target && zip -qr paul-test-lambda.zip ./*.js.map ./*.js`,
	},
};
