...
import com.gu.sf_contact_merge.getsfcontacts.GetSfContact
...
object ValidateNoLosingDigitalVoucher {
  ...
  def apply(losingContacts: List[LazyClientFailableOp[GetSfContact.IsDigitalVoucherUser]]): ApiGatewayOp[Unit] =
