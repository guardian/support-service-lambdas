...
class DeliveryRecordApiRoutes[F[_]: Effect](
    createDeliveryProblemService: CreateDeliveryProblemService[F],
    getDeliveryRecordsService: GetDeliveryRecordsService[F],
) {
