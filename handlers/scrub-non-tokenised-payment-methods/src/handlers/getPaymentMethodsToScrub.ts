 ...
 * subscription is cancelled and out of term. Writes it to S3 rather than
 * returning it, because the distributed map reads its items from a file and a
 * list this size will not fit in the payload passed between states.
 */
