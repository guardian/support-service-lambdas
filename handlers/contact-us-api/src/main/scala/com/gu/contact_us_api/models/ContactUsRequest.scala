...
case class ContactUsRequest(topic: String, subtopic: Option[String], subsubtopic: Option[String], name: String, email: String, subject: String, message: String, attachment: Option[AttachmentDetails]) {
