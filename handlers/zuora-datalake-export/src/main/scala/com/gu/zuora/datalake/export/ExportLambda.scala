...
object Query extends Enum[Query] {
  ...
  case object PaymentMethod extends Query(
    "PaymentMethod",
    "SELECT BankTransferType, CreditCardExpirationMonth, CreditCardExpirationYear, LastFailedSaleTransactionDate, LastTransactionDateTime, LastTransactionStatus, Name, NumConsecutiveFailures, PaymentMethodStatus, Type, ID, MandateID, PaypalBAID, SecondTokenID, TokenID, AccountID, AchAbaCode, AchAccountName, AchAccountNumberMask, AchAccountType, AchAddress1, AchAddress2, AchBankName, AchCity, AchCountry, AchPostalCode, AchState, Active, BankBranchCode, BankCheckDigit, BankCity, BankCode, BankIdentificationNumber, BankName, BankPostalCode, BankStreetName, BankStreetNumber, BankTransferAccountName, BankTransferAccountNumberMask, BankTransferAccountType, BusinessIdentificationCode, City, CompanyName, Country, CreatedById, CreatedDate, CreditCardAddress1, CreditCardAddress2, CreditCardCity, CreditCardCountry, CreditCardHolderName, CreditCardMaskNumber, CreditCardPostalCode, CreditCardState, CreditCardType, DeviceSessionId, Email, ExistingMandate, FirstName, IBAN, IdentityNumber, IPAddress, IsCompany, LastName, MandateCreationDate, MandateReceived, MandateUpdateDate, MaxConsecutivePaymentFailures, PaymentRetryWindow, PaypalEmail, PaypalPreapprovalKey, PaypalType, Phone, PostalCode, State, StreetName, StreetNumber, TotalNumberOfErrorPayments, TotalNumberOfProcessedPayments, UpdatedById, UpdatedDate, UseDefaultRetryRule FROM PaymentMethod",
