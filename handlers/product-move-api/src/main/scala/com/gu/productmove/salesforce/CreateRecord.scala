...
private class CreateRecordLive(salesforceClient: SalesforceClient) extends CreateRecord :
  override def create(requestBody: CreateRecordRequest): IO[String, CreateRecordResponse] = salesforceClient.post[CreateRecordRequest, CreateRecordResponse](requestBody, uri"/services/data/v55.0/sobjects/Subscription_Rate_Plan_Update__c/")
