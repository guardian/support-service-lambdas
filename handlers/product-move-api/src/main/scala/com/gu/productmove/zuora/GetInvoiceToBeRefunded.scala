...
object GetInvoiceToBeRefunded {
  ...
  case class GetInvoiceItemsResponse(records: List[InvoiceItem]) {
    ...
    private def getNegativeInvoice = getInvoicesSortedByDate.head
    
    def getNegativeInvoiceId = getNegativeInvoice._1

    private def getLastPaidInvoice = getInvoicesSortedByDate.tail.head
