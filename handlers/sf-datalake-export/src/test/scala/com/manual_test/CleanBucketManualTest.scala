...
import com.gu.sf_datalake_export.handlers.{CleanBucketHandler, DownloadBatchHandler}

//This is just a way to locally run the lambda in code
object CleanBucketManualTest extends App {
  val request =
    """{
  ...
  CleanBucketHandler(testInputStream, testOutput, null)
