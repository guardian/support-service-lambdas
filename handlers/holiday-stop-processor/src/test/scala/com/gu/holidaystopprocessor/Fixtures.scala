...
import com.gu.salesforce.holiday_stops.SalesforceHolidayStopRequestsDetail.{HolidayStopRequestId, HolidayStopRequestsDetail, HolidayStopRequestsDetailChargeCode, HolidayStopRequestsDetailId, HolidayStopRequestsDetailSearchQueryResponse, ProductName, StoppedPublicationDate, SubscriptionName}
