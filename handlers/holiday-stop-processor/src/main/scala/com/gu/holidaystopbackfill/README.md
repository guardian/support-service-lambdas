...
1. Export the report results to your dev machine.  
   ...
   You should end up with a CSV report with a header row and five columns: subscription name, charge code, holiday start date, holiday end date and credit.
...
1. The script will tell you what it has written to Salesforce, if anything.  
   You might want to send the output to a file for reference.
