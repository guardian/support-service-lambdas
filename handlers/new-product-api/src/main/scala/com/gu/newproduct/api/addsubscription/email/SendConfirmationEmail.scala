...
object SendConfirmationEmail1 extends Logging {

  case class ContributionsEmailData1(
    accountId: ZuoraAccountId,
    currency: Currency,
    paymentMethod: PaymentMethod,
    amountMinorUnits: AmountMinorUnits,
  ...
  def toContributionFields(currentDate: LocalDate, data: ContributionsEmailData1): Option[ContributionFields] = {
