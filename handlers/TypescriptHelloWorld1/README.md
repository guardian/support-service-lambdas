...
```bash
TypescriptHelloWorld1$ sam build
```
...
```bash
TypescriptHelloWorld1$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
TypescriptHelloWorld1$ sam local start-api
TypescriptHelloWorld1$ curl http://localhost:3000/
```
...
```bash
TypescriptHelloWorld1$ sam logs -n HelloWorldFunction --stack-name TypescriptHelloWorld1 --tail
```
...
```bash
TypescriptHelloWorld1$ cd hello-world
...
```bash
sam delete --stack-name TypescriptHelloWorld1
```
