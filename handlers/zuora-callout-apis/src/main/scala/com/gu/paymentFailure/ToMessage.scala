...
object ToMessage {
  ...
  def apply(
    ...
    paymentFailureCallout.email match {
      case None =>
        Left(
          s"Cannot create email message: no email address associated with accountId: ${paymentFailureCallout.accountId} and sfContactId: ${paymentFailureCallout.sfContactId}",
        )
            ...
            To = ToDef(
              ...
              ContactAttributes = ContactAttributesDef(
                SubscriberAttributes = SubscriberAttributesDef(
                  ...
                  card_expiry_date =
                    paymentFailureCallout.creditCardExpirationMonth + "/" + paymentFailureCallout.creditCardExpirationYear,
  ...
  def apply(
    ...
    callout.email match {
      ...
      case None =>
        Left(
          s"Cannot create email message: no email address associated with accountId: ${callout.accountId} and sfContactId: ${callout.sfContactId}",
        )
    }
