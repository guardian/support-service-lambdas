...
object ZuoraSarServiceStub {
  ...
  def withFailedContactResponse = new ZuoraSarServiceStub(failedZuoraContactResponse, zuoraAccountSuccess, zuoraInvoiceSuccess)
  def withFailedAccountResponse = new ZuoraSarServiceStub(successfulZuoraContacts, zuoraAccountFailure, zuoraInvoiceSuccess)
  def withFailedInvoiceResponse = new ZuoraSarServiceStub(successfulZuoraContacts, zuoraAccountSuccess, zuoraInvoiceFailure)
}
