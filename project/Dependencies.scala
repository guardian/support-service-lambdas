...
object Dependencies {
  ...
  val jacksonDatabind = "com.fasterxml.jackson.core" % "jackson-databind" % "2.10.0" // Necessary because the aws-sdk often depends on an old version, which gets flagged by snyk
