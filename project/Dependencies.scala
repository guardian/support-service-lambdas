...
object Dependencies {
  ...
  // GCP
  val googleBigQuery = "com.google.cloud" % "google-cloud-bigquery" % "2.52.0"
  ...
  // Other
  val zio = "dev.zio" %% "zio" % "2.1.19"
  val zio2Version = "2.1.18"
  val zio2 = "dev.zio" %% "zio" % zio2Version
  val tapirVersion =
    "1.11.36" // stick with 1.11.33 for now as later versions indirectly pull in netty-codec-base which duplicates netty-codec content
