...
object Dependencies {
  ...
  val http4sVersion = "0.23.34" // keep version 0.22.15, later versions pull in cats effect 3 which is not compatible
  ...
  // Guardian
  val simpleConfig = "com.gu" %% "simple-configuration-ssm" % "10.0.0"
